...
-- collide and keeping the earliest creator. The reasoning lives beside the
-- constant that embeds this file, in `migrations/mod.rs`; a shipped migration
-- is hash-addressed over its whole text, so prose here cannot be corrected.
