 ...
 * given — plus two test-only hooks to read the registrations back and to
 * invoke a tool's `execute`. Everything on the other side of that boundary is
 * real: the served manifest, the registration script, the request `execute`
 * builds, and the endpoint that answers it.
 *
