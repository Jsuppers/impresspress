...
// `IMPRESSPRESS_WEB_SNIPPETS` — the third part of a `wasm-pack --target web`
// output, generated by `build.rs` because the file list is whatever
// `crates/impresspress-web/pkg/snippets` holds. Its doc comment is in the
// generated file.
include!(concat!(env!("OUT_DIR"), "/impresspress-web-snippets.rs"));
